                              ...
                              <li class="nav-item dropdown notification-list">
                                <a class="nav-link dropdown-toggle arrow-none waves-light waves-effect" data-toggle="dropdown" href="#" role="button"
                                   aria-haspopup="false" aria-expanded="false">
                                    ...
                                    <span class="noti-icon-badge"><a href="{{route('cart.show',Auth::user()->id)}}">Cart: ${{number_format($total)}}</a></span>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-lg" aria-labelledby="Preview">
                                    <!-- item-->
                                    <div class="dropdown-item noti-title">
                                        <h5><small><span class="label label-danger pull-xs-right"> 45</span>Pending Tasks</small></h5>
                                    </div>                                    
                ...
                <div class="container">
                    <div id="navigation">
                        ...
                        <ul class="navigation-menu">
                            ...
                            <li class="has-submenu">
                                <a href="{{URL('/reports')}}"><i class="zmdi zmdi-local-wc"></i>Report</a>                               
                            </li>
                            ...
                            <li class="has-submenu">
                                <a href="{{route('user.index')}}"><i class="zmdi zmdi-whatsapp"></i>Users</a>
                            </li>
